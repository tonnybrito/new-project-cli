...
Este CLI gera projetos a partir de um **template** pré‑definido.
...
- *Automatização* de etapas repetitivas (instalar dependências, iniciar git, criar repositório no GitHub).
